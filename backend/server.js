...
import dotenv from "dotenv";
import mongoose from "mongoose";
import API from "./models/routes/api.js"; // must be ESM-compatible
...
// Cache connection for serverless (Vercel spawns fresh lambdas per request)
...
app.use("/api", API);
app.get("/", (req, res) => {
  res.send("✅ API is working (Vercel-ready)");
});
